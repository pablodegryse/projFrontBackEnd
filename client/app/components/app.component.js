...
var AppComponent = (function () {
    ...
    AppComponent.prototype.setSocketEvents = function (socket, drawer, serverMessages) {
    ...
    ], AppComponent.prototype, "drawCanvas", void 0);
    __decorate([
        core_1.ViewChild('buttonList'), 
        __metadata('design:type', Object)
    ], AppComponent.prototype, "buttonList", void 0);
    __decorate([
        core_1.ViewChild('serverMessages'), 
        __metadata('design:type', Object)
    ], AppComponent.prototype, "serverMessages", void 0);
    AppComponent = __decorate([
        core_1.Component({
            selector: "my-app",
            templateUrl: "./views/componentViews/testComponent.html"
        }), 
